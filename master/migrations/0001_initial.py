    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('national_code', models.CharField(max_length=125, validators=[django.core.validators.RegexValidator('^[0-9]{10}$', 'same as pattern')], verbose_name='کد ملی')),
                ('profile_image', models.ImageField(blank=True, upload_to=extenstion.utils.get_file_path, verbose_name='تصویر پزوفایل')),
